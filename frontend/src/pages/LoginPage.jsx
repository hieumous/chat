      ...
      <div className="relative w-full max-w-6xl md:h-[800px] h-[650px]">
        <BorderAnimatedContainer>
          <div className="w-full flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-gray-300">
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-gray-100 to-transparent">
              <div>
                <img
                  src="/login.png"
